...
var i: Integer;
    connection_server : TConnection_Server;
begin
  configfile.connection.parameters.Values['filename']:= edtFileDataBaseName.Text;
  connection_server:= configfile.connection_server;
  connection_server.host:= edtHost.Text;
  connection_server.port:= edtPort.Text;
  connection_server.appid:= edAppId.Text;
  configfile.connection_server:= connection_server;
...
begin
  ...
  edtHost.Text:= configfile.connection_server.host;
  edtPort.Text:= configfile.connection_server.port;
  edAppId.Text:= configfile.connection_server.appid;
